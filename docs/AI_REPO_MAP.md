...
| Compile-time feature flags, custom builds, approved plugins | `include/hds_features.h`, `platformio.ini`, `tools/configure_custom_build.py`, `custom-build.json` | `docs/AI_BUILD_NOTES.md` |
...
| HTTP and runtime LittleFS serving | `include/webserver.h`, matching `web_apps/` or `plugins/` file | `docs/AI_BUILD_NOTES.md`, `docs/AI_FIRMWARE_NOTES.md` |
...
| Pull OTA, staged LittleFS replacement, signing, rollback | `include/pull_ota.h`, `include/ota_rollback.h`, `.github/workflows/release.yml` | `docs/AI_OTA_NOTES.md` |
| Custom-build workflow and selector | `.github/workflows/custom-build.yml`, `docs/custom-build/index.html`, `docs/custom-build/catalog.json` | `docs/AI_BUILD_NOTES.md` |
