...
The dashboard links directly to `/apps/quality-control-assistant/index.html`. The previous `/Quality_Control_Assistant/quality_control.html` URL redirects there when this plugin is selected.
