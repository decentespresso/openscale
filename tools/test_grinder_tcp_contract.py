...
def test_firmware_contracts():
    ...
    assert_contains(MENU_HEADER, "Grind by weight")
    ...
    assert_contains(MENU_HEADER, "WiFi Off deferred until Grind by weight is disabled.")
    ...
    assert_contains(HDS_SOURCE, "showMenu();")
