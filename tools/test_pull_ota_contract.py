...
def main():
    ...
    assert_contains(PULL_OTA_HEADER, "bool pullOtaSelectReleases(JsonArray releases, PullOtaReleaseList &list)")
    assert_contains(PULL_OTA_HEADER, "bool pullOtaSelectReleases(JsonObject root, PullOtaReleaseList &list)")
