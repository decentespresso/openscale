...
def main():
    ...
    assert_contains(text, "release-files/ota_public.pem")
    assert_contains(text, "openssl dgst -sha256 -verify release-files/ota_public.pem -signature release-files/manifest.sig release-files/manifest.json")
    ...
    assert_before(text, "python tools/generate_release_manifest.py", "openssl dgst -sha256 -verify release-files/ota_public.pem")
    assert_before(text, "openssl dgst -sha256 -verify release-files/ota_public.pem", "gh release create")
