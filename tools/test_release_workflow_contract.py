...
def main():
    ...
    assert_contains(text, "openssl pkey -pubout -out .pio.nosync/release/custom-ota-public-key.pem")
    assert_contains(text, "HDS_CUSTOM_OTA_PUBLIC_KEY_FILE: .pio.nosync/release/custom-ota-public-key.pem")
