...
- `manifest.sig`: detached SHA-256 signature. The workflow requires `HDS_OTA_SIGNING_KEY_PEM` as a protected `release` environment secret. Firmware trusts the three public keys tracked under `keys/ota/`.
