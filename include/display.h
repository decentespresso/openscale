...
#ifdef HW_I2C
#ifdef SSD1306
U8G2_SSD1306_128X64_NONAME_1_HW_I2C u8g2(U8G2_R0, OLED_RST);
#endif
#ifdef SSD1312
U8G2_SSD1312_128X64_NONAME_1_HW_I2C u8g2(U8G2_R0, OLED_RST);
#endif
#if defined(SH1106) || defined(SH1116)
U8G2_SH1106_128X64_NONAME_1_HW_I2C u8g2(U8G2_R0, OLED_RST);
#endif
#endif
#ifdef HW_SPI
#ifdef SSD1306
...
#ifdef SW_SPI
#if defined(SH1106) || defined(SH1116)
U8G2_SH1106_128X64_NONAME_1_4W_SW_SPI u8g2(U8G2_R0, OLED_SCLK, OLED_SDIN, OLED_CS, OLED_DC, OLED_RST);
#endif
#endif
#ifdef SW_SPI_OLD
...
#endif
#ifdef SW_SPI
U8G2_SSD1306_128X64_NONAME_1_4W_SW_SPI u8g2(U8G2_R0, OLED_SCLK, OLED_SDIN, OLED_CS, OLED_DC, OLED_RST);
#endif
#ifdef SW_I2C
...
static const unsigned char image_heart_13x13[] =  {0x0c,0x06,0x1e,0x0f,0xbf,0x1f,0xff,0x1f,0xff,0x1f,0xff,0x1f,0xff,0x1f,0xfe,0x0f,0xfc,0x07,0xf8,0x03,0xf0,0x01,0xe0,0x00,0x40,0x00};
